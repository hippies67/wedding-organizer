    ...
    <div class="container d-xl-flex align-items-start">
        <div class="hero_about col-xl-6">
            <div class="hero_header">
                <h1 class="hero_header-title">Mari Rencanakan Pernikahan Yang Sempurna Bersama</h1>
        ...
        <div class="hero_promo col-xl-6">
            <div>
                <picture>
                    <source data-srcset="{{ asset('hero-1.jpg') }}" srcset="{{ asset('hero-1.jpg') }}"  type="image/webp" />
                    <img class="lazy" data-src="{{ asset('hero-1.jpg') }}" src="{{ asset('hero-1.jpg') }}" alt="media" />
                </picture>
            </div>
        </div>
    </div>
...
<section class="featured section--nopb">
    <div class="container">
        <div class="featured_header">
            <h2 class="featured_header-title">Paket Pilihan</h2>
            ...
            @foreach($paket_wedding as $item)
                <div class="products_list-item">
                    ...
                    <div class="products_list-item_wrapper d-flex flex-column">
                        <div class="media">
                            <a href="{{ url('paket-wedding', $item->slug) }}" rel="noopener norefferer" style="width: 100% !important;"> 
                        ...
                        <div class="main d-flex flex-column align-items-center justify-content-between">
                            ...
                            <a class="main_title" href="{{ url('paket-wedding', $foto->paket_wedding->slug) }}" rel="noopener norefferer">{{ $foto->paket_wedding->nama_paket }}</a>
                            ...
                            <div class="main_price">
                                <span class="price">Rp . {{ number_format((float)$foto->paket_wedding->harga_paket, 0, ',', '.') }}</span>
                            </div>
    ...
    <div class="container">
        <div class="about_main d-lg-flex justify-content-between">
            ...
            <div class="about_main-media">
                <picture>
                    <source data-srcset="{{ asset('front/img/placeholder.jpg') }}" srcset="{{ asset('front/img/placeholder.jpg') }}" type="image/webp" />
                    <img class="lazy" data-src="{{ asset('front/img/placeholder.jpg') }}" src="{{ asset('front/img/placeholder.jpg') }}" alt="media" />
                </picture>
            </div>
        </div>
    ...
    <div class="container d-flex flex-column flex-lg-row">
        <div class="product_media">
            <picture>
                ...
                <img
                    class="lazy"
                    data-src="{{ asset('front/img/placeholder.jpg') }}"
                    src="{{ asset('front/img/placeholder.jpg') }}"
    ...
    <div class="container">
        ...
        <div class="latest_wrapper d-flex flex-column-reverse flex-lg-row">
            <div class="latest_promo" data-aos="fade-right">
                <picture>
                    <source srcset="{{ asset('front/img/placeholder.jpg') }}" type="image/webp" />
                    <img class="lazy latest_promo-bg" data-src="{{ asset('front/img/placeholder.jpg') }}" src="{{ asset('front/img/placeholder.jpg') }}" alt="promo" />
                </picture>
...
<section class="instagram" style="margin-top: 100px;">
    <div class="container">
        <div class="instagram_header">
            <h2 class="instagram_header-title">Ikuti Kita di Instagram</h2>
        ...
        <div class="swiper-wrapper">
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{ asset('footer-1.jpg') }}" src="{{ asset('footer-1.jpg') }}" style="object-fit: cover;height: 400px;" alt="instagram post" />
                    </picture>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{ asset('footer-2.jpg') }}" src="{{ asset('footer-2.jpg') }}" style="object-fit: cover;height: 400px;" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{ asset('footer-3.jpg') }}" src="{{ asset('footer-3.jpg') }}" style="object-fit: cover;height: 400px;" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{ asset('footer-4.jpg') }}" src="{{ asset('footer-4.jpg') }}" style="object-fit: cover;height: 400px;" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            {{-- <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        <source data-srcset="{{ asset('front/img/placeholder.jpg') }}" srcset="{{ asset('front/img/placeholder.jpg') }}" type="image/webp" />
                        <img class="lazy" data-src="{{ asset('front/img/placeholder.jpg') }}" src="{{ asset('front/img/placeholder.jpg') }}" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
