...
<header class="page" style="margin-top: 140px;">
    <div class="page_main container-fluid" >
        <div class="container">
            <h1 class="page_header" style="color: #ffffff;">Paket Wedding</h1>
                            ...
                            <li class="shop_products-list_item col-sm-6 col-md-4 col-lg-6 col-xl-4" data-order="1">
                                <div class="wrapper d-flex flex-column">
                                    <div class="media">
                                        ...
                                        <div class="overlay d-flex flex-column align-items-center justify-content-center">
                                            <ul class="action d-flex align-items-center justify-content-center">
                                                <li class="list-item">
                                                    <input type="hidden" name="paket_wedding_id" id="paketWeddingId{{ $item->id }}" value="{{ $item->id }}">
                                                    @if(Auth::guard('web')->user())
                                                    <input type="hidden" name="user_id" id="userId{{ $item->id }}" value="{{ isset(Auth::guard('web')->user()->id) ? Auth::guard('web')->user()->id : '' }}">
                                                    @endif
                                                    @if(Auth::guard('web')->user())
                                                        @php
                                                        ...
                                                        @endphp
                                                        @if($check >= 1)
                                                        <a href="{{ route('pemesanan-wa', Auth::guard('web')->user()->id) }}" type="button" class="action_link d-flex align-items-center justify-content-center">
                                                            <i class="icon-basket"></i>
                                                        </a>
                                                        @else
                                                        <button type="button" class="action_link d-flex align-items-center justify-content-center" onclick="keranjangButtonInPaketWeeding({{ $item->id }})">
                                                            <i class="icon-basket"></i>
                                                        </button>
                                                        @endif
                                                    @else
                                                    <a data-bs-toggle="offcanvas" data-bs-target="#loginCanvas" class="action_link d-flex align-items-center justify-content-center">
                                                        <i class="icon-basket"></i>
                                                    </a>
                                                    @endif
                                                </li>
                                                <li class="list-item">
                                                    <a class="action_link d-flex align-items-center justify-content-center" href="{{ url('paket-wedding', $item->slug) }}">
                                                        <i class="icon-eye"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <picture>
                                                ...
                                                <img class="lazy" data-src="{{ asset('paket_wedding/'. $foto->url) }}" src="{{ asset('paket_wedding/'. $foto->url) }}" alt="media" />
                                            </picture>
                                        </a>
                                    </div>
                                    <div class="main d-flex flex-column">
                                        ...
                                        <a class="main_title" href="{{ url('paket-wedding', $foto->paket_wedding->slug) }}" target="_blank" rel="noopener norefferer"
                                            >{{ $foto->paket_wedding->nama_paket }}</a
                                        >
