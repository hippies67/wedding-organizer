...
<main>
    <section class="cart section">
        <div class="container"> 
                ...
                <p style="margin-top: 10px;">Harap bayar pesanan anda melalui whatsapp terlebih dahulu sebelum memesan paket yang lain.</p>
                <div class="d-flex" style="margin-top: 20px;">
                    @foreach($web as $data)
                        <a href="https://wa.me/{{ $data->whatsapp }}?text={{ urlencode("hallo kak saya " . Auth::guard('web')->user()->nama . " dengan 𝐈𝐃 : " . Auth::guard('web')->user()->id . " mau bayar pesanan") }}" class="btn" style="font-size: 15px;" id="bayarPaket"><i class="fa-brands fa-whatsapp" style="margin-right: 10px;"></i> Bayar Lewat Whatsapp</a>
                    @endforeach
                    @if(count($web) < 1)
                    <a class="link" href="https://wa.me/6285156574497">+6285156574497</a>
                    @endif
                    <button type="button" class="btn" style="font-size: 15px;margin-left: 20px !important;" id="bayarPaket" onclick="batalPesanan()"><i class="fas fa-do-not-enter" style="margin-right: 10px;"></i> Batalkan Pesanan</button>
                </div>
