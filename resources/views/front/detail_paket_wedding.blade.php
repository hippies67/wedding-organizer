    ...
    <div class="container">
        ...
        <div class="about_main d-lg-flex flex-nowrap">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <a href="{{ asset('paket_wedding/'. $foto->url) }}" data-role="gallery">
                                <picture>
                                    <source
                                        data-srcset="{{ asset('paket_wedding/'. $foto->url) }}"
            ...
            <div class="about_main-info">
                ...
                <span class="about_main-info_price">RP. {{ number_format((float)$paket_wedding->harga_paket, 0, ',', '.') }} </span>
                <div class="about_main-info_buy d-flex align-items-center">
                    <div class="qty d-flex align-items-center justify-content-between">
                        ...
                        <input class="qty_amount" type="number" readonly value="1" min="1" max="99" id="jumlah_paket" name="jumlah_paket" />
                    ...
                    <form action="#" method="post">
                        @if(Auth::guard('web')->user())
                            ...
                            <input type="hidden" name="user_id" value="{{ isset(Auth::guard('web')->user()->id) ? Auth::guard('web')->user()->id : '' }}">
                            @php
                                $check = \App\Models\Pemesanan::where('user_id', Auth::guard('web')->user()->id)->count();
                            @endphp
                            @if($check >= 1)
                            <div style="display: flex; justify-conten: center;">
                                <a href="{{ route('pemesanan-wa', Auth::guard('web')->user()->id) }}" class="btn" style="font-size: 15px;margin-top: 20px !important;">Tambah Ke Keranjang</a>
                            </div>
                            @else 
                            <button type="button" class="btn" id="keranjangButton">Tambah Ke Keranjang</button>
                            @endif
                        @else
                            <a data-bs-toggle="offcanvas" data-bs-target="#loginCanvas" class="btn">Tambah Ke Keranjang</a>
                        @endif
                    </form>
                </div>
