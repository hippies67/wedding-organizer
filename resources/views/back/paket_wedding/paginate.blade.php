                                        ...
                                        <div class="button-list">
                                            <div class="buttons d-flex justify-content-between">
                                                <button type="button" data-toggle="modal" style="width: 100%;"
                                                    ...
                                                    onclick="editPaketWeddingFunction('<?=$data->id ?>', '<?=$data->nama_paket?>', '<?=$data->harga_paket?>', '<?=$data->deskripsi_paket?>', '<?=$data->foto_paket?>')"
                                                    class="btn btn-warning btn-xxs text-white mr-2"><i
                                                        class="fa fa-edit mr-1"></i>Edit
                                                </button>
                                                <button type="button" style="width: 100%;"
                                                    onclick="detailPaketWeddingFunction('<?=$data->id ?>', '<?=$data->nama_paket?>', '<?=$data->harga_paket?>', '<?=$data->deskripsi_paket?>', '<?=$data->foto_paket?>')"
